#include "/home/creitin/Documents/apt-src/include/apt-pkg/tagfile-keys.h"
#ifdef __GNUC__
...
static enum pkgTagSection::Key pkgTagHash9(const char *string)
{
    ...
    case 0| onechar('p', 0, 8):
        switch(*((triehash_uu64*) &string[1]) | 0x2020202020202020) {
        case 0| onechar('r', 0, 64)| onechar('o', 8, 64)| onechar('t', 16, 64)| onechar('e', 24, 64)| onechar('c', 32, 64)| onechar('t', 40, 64)| onechar('e', 48, 64)| onechar('d', 56, 64):
            return pkgTagSection::Key::Protected;
        }
        break;
    case 0| onechar('t', 0, 8):
        switch(*((triehash_uu64*) &string[1]) | 0x2020202020202020) {
...
static enum pkgTagSection::Key pkgTagHash10(const char *string)
{
    ...
    case 0| onechar('m', 0, 32)| onechar('a', 8, 32)| onechar('i', 16, 32)| onechar('n', 24, 32):
        switch(*((triehash_uu32*) &string[4]) | 0x20202020) {
        case 0| onechar('t', 0, 32)| onechar('a', 8, 32)| onechar('i', 16, 32)| onechar('n', 24, 32):
            switch(string[8] | 0x20) {
            case 0| onechar('e', 0, 8):
        ...
        break;
    case 0| onechar('m', 0, 32)| onechar('u', 8, 32)| onechar('l', 16, 32)| onechar('t', 24, 32):
        switch(string[4] | 0x20) {
        case 0| onechar('i', 0, 8):
            switch(string[5]) {
            case 0| onechar('-', 0, 8):
        ...
        break;
    case 0| onechar('r', 0, 32)| onechar('e', 8, 32)| onechar('c', 16, 32)| onechar('o', 24, 32):
        switch(*((triehash_uu32*) &string[4]) | 0x20202020) {
        case 0| onechar('m', 0, 32)| onechar('m', 8, 32)| onechar('e', 16, 32)| onechar('n', 24, 32):
            switch(string[8] | 0x20) {
            case 0| onechar('d', 0, 8):
                switch(string[9] | 0x20) {
                case 0| onechar('s', 0, 8):
                    ...
                    case 0| onechar('v', 0, 32)| onechar('e', 8, 32)| onechar('r', 16, 32)| onechar('s', 24, 32):
                        ...
                        case 0| onechar('i', 0, 8):
                            ...
                            case 0| onechar('o', 0, 8):
                                switch(string[13] | 0x20) {
                                case 0| onechar('n', 0, 8):
                                    return pkgTagSection::Key::Source_Version;
                                }
                            }
                        }
                    }
        ...
        case 0| onechar('d', 0, 8):
            ...
            case 0| onechar('-', 0, 8):
                ...
                case 0| onechar('c', 0, 64)| onechar('o', 8, 64)| onechar('n', 16, 64)| onechar('f', 24, 64)| onechar('l', 32, 64)| onechar('i', 40, 64)| onechar('c', 48, 64)| onechar('t', 56, 64):
                    ...
                    break;
                case 0| onechar('e', 0, 64)| onechar('s', 8, 64)| onechar('s', 16, 64)| onechar('e', 24, 64)| onechar('n', 32, 64)| onechar('t', 40, 64)| onechar('i', 48, 64)| onechar('a', 56, 64):
                    switch(string[14] | 0x20) {
                    case 0| onechar('l', 0, 8):
                        return pkgTagSection::Key::Build_Essential;
                    }
                }
            }
        }
...
static enum pkgTagSection::Key pkgTagHash16(const char *string)
{
    ...
    case 0| onechar('c', 0, 64)| onechar('h', 8, 64)| onechar('e', 16, 64)| onechar('c', 24, 64)| onechar('k', 32, 64)| onechar('s', 40, 64)| onechar('u', 48, 64)| onechar('m', 56, 64):
        switch(string[8] | 0x20) {
        case 0| onechar('s', 0, 8):
            switch(string[9]) {
            case 0| onechar('-', 0, 8):
...
{
    switch(*((triehash_uu64*) &string[0]) | 0x2020202020202020) {
    case 0| onechar('s', 0, 64)| onechar('t', 8, 64)| onechar('a', 16, 64)| onechar('n', 24, 64)| onechar('d', 32, 64)| onechar('a', 40, 64)| onechar('r', 48, 64)| onechar('d', 56, 64):
        switch(string[8] | 0x20) {
        case 0| onechar('s', 0, 8):
            switch(string[9]) {
            case 0| onechar('-', 0, 8):
...
{
    switch(*((triehash_uu32*) &string[0]) | 0x20202020) {
    case 0| onechar('a', 0, 32)| onechar('u', 8, 32)| onechar('t', 16, 32)| onechar('o', 24, 32):
        switch(string[4]) {
        case 0| onechar('-', 0, 8):
            ...
            case 0| onechar('b', 0, 32)| onechar('u', 8, 32)| onechar('i', 16, 32)| onechar('l', 24, 32):
                ...
                case 0| onechar('t', 0, 8):
                    switch(string[10]) {
                    case 0| onechar('-', 0, 8):
                        switch(*((triehash_uu32*) &string[11]) | 0x20202020) {
                        case 0| onechar('p', 0, 32)| onechar('a', 8, 32)| onechar('c', 16, 32)| onechar('k', 24, 32):
                            switch(string[15] | 0x20) {
                            case 0| onechar('a', 0, 8):
                                switch(string[16] | 0x20) {
                                case 0| onechar('g', 0, 8):
                                    ...
                                    case 0| onechar('e', 0, 8):
                                        return pkgTagSection::Key::Auto_Built_Package;
                                    }
                                }
                            }
                        }
                ...
                case 0| onechar('-', 0, 8):
                    ...
                    case 0| onechar('b', 0, 32)| onechar('u', 8, 32)| onechar('i', 16, 32)| onechar('l', 24, 32):
                        ...
                        case 0| onechar('t', 0, 8):
                            switch(string[12]) {
                            case 0| onechar('-', 0, 8):
                                switch(*((triehash_uu32*) &string[13]) | 0x20202020) {
                                case 0| onechar('u', 0, 32)| onechar('s', 8, 32)| onechar('i', 16, 32)| onechar('n', 24, 32):
                                    switch(string[17] | 0x20) {
                                    case 0| onechar('g', 0, 8):
                                        return pkgTagSection::Key::Static_Built_Using;
                                    }
                                }
                            }
                        }
...
static enum pkgTagSection::Key pkgTagHash20(const char *string)
{
    ...
    case 0| onechar('a', 0, 32)| onechar('r', 8, 32)| onechar('c', 16, 32)| onechar('h', 24, 32):
        ...
        case 0| onechar('i', 0, 64)| onechar('t', 8, 64)| onechar('e', 16, 64)| onechar('c', 24, 64)| onechar('t', 32, 64)| onechar('u', 40, 64)| onechar('r', 48, 64)| onechar('e', 56, 64):
            ...
            case 0| onechar('-', 0, 8):
                switch(*((triehash_uu32*) &string[13]) | 0x20202020) {
                case 0| onechar('v', 0, 32)| onechar('a', 8, 32)| onechar('r', 16, 32)| onechar('i', 24, 32):
                    switch(string[17] | 0x20) {
                    case 0| onechar('a', 0, 8):
                        switch(string[18] | 0x20) {
                        case 0| onechar('n', 0, 8):
                            ...
                            case 0| onechar('t', 0, 8):
                                return pkgTagSection::Key::Architecture_Variant;
                            }
                        }
                    }
                }
...
static enum pkgTagSection::Key pkgTagHash24(const char *string)
{
    switch(*((triehash_uu32*) &string[0]) | 0x20202020) {
    case 0| onechar('p', 0, 32)| onechar('h', 8, 32)| onechar('a', 16, 32)| onechar('s', 24, 32):
        switch(string[4] | 0x20) {
        case 0| onechar('e', 0, 8):
            switch(string[5] | 0x20) {
            case 0| onechar('d', 0, 8):
                ...
                case 0| onechar('-', 0, 8):
                    switch(*((triehash_uu32*) &string[7]) | 0x20202020) {
                    case 0| onechar('u', 0, 32)| onechar('p', 8, 32)| onechar('d', 16, 32)| onechar('a', 24, 32):
                        switch(string[11] | 0x20) {
                        case 0| onechar('t', 0, 8):
                            switch(string[12] | 0x20) {
                            case 0| onechar('e', 0, 8):
                                switch(string[13]) {
                                case 0| onechar('-', 0, 8):
                                    switch(*((triehash_uu64*) &string[14]) | 0x2020202020202020) {
                                    case 0| onechar('p', 0, 64)| onechar('e', 8, 64)| onechar('r', 16, 64)| onechar('c', 24, 64)| onechar('e', 32, 64)| onechar('n', 40, 64)| onechar('t', 48, 64)| onechar('a', 56, 64):
                                        switch(string[22] | 0x20) {
                                        case 0| onechar('g', 0, 8):
                                            switch(string[23] | 0x20) {
                                            case 0| onechar('e', 0, 8):
                                                return pkgTagSection::Key::Phased_Update_Percentage;
                                            }
                                        }
                                    }
                                }
